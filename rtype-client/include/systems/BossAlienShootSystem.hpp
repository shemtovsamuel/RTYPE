...
namespace rtype
{
    namespace system
    {
        ...
        /**
             ...
             * @param entityManager 
             */
            BossAlienShootSystem(engine::ecs::EntityManager<rtype::config::ComponentCount, rtype::config::SystemCount> &entityManager) : _entityManager(entityManager), _entityTemplate(entityManager), _lastShotTime(std::chrono::high_resolution_clock::now())
            {
                setRequirements<
