...
namespace rtype
{
    namespace system
    {
        ...
        public:
             ...
             * @param entityManager 
             */
            SpawnBonusSystem(engine::ecs::EntityManager<rtype::config::ComponentCount, rtype::config::SystemCount>& entityManager) : _id(0), _entityManager(entityManager), _entityTemplate(entityManager)
            {
                setRequirements<
            ...
            void update(const float dt)
            {
                ...
                {
                    auto [state, id, transform] = _entityManager.getComponents<
                        rtype::ecs::components::State,
                        rtype::ecs::components::EnnemiId,
                        engine::ecs::components::Transform
                    >(entity);
